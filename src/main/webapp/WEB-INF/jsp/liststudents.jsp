...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid">
            <input type="button" value="Add Teacher/Student"
            ...
            <table class="table table-bordered">
                ...
                <c:forEach items="${studentlist}" var="student">
                    <tr>
                        ...
                        <td>${student.person.category.categoryname}</td>
                        <td>${student.cls.class_desc}</td>

                        <td>
                            <input type="button" value="Edit"
                                   onclick="window.location.href='/edit?id=${student.person.perid}'; return false;"
                                   class="btn btn-primary" />
                            <input type="button" value="Delete"
                                   onclick="window.location.href='/delete?id=${student.person.perid}'; return false;"
                                   class="btn btn-primary" />
                        </td>
                    </tr>
                </c:forEach>
