    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid">
            <input type="button" value="Add Class"
                   onclick="window.location.href='showclassForm'; return false;"
            ...
            <table class="table table-bordered">
                ...
                <c:forEach items="${classes}" var="cls">
                    <tr>
                        ...
                        <td>${cls.person.name} ${cls.person.surname}</td>
                        <td>
                            <input type="button" value="Edit"
                                   onclick="window.location.href='/editclass?id=${cls.class_id}'; return false;"
                                   class="btn btn-primary" />
                            <input type="button" value="Delete"
                                   onclick="window.location.href='/deleteclass?id=${cls.class_id}'; return false;"
                                   class="btn btn-primary" />
                            <input type="button" value="Assign Teacher"
                                   onclick="window.location.href='/assignclass?id=${cls.class_id}'; return false;"
                                   class="btn btn-primary" />
                            <input type="button" value="Assign To Subject"
                                   onclick="window.location.href='/assignclasstosubject?id=${cls.class_id}&per_id=${cls.person.perid}'; return false;"
                                   class="btn btn-primary" />
                        </td>
                    </tr>
                </c:forEach>
